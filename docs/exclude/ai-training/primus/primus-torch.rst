...
************************************************
Train a model with Primus and PyTorch torchtitan
************************************************
...
.. note::
   ...
   :doc:`ROCm PyTorch training (legacy)
   </ai-training/primus/archive/pytorch-training>` workflow.
...
.. datatemplate:yaml:: ./data/primus-pytorch.yaml
...
See :doc:`/ai-training/primus/archive/pytorch-training-history` to find
documentation for previous releases of the ``rocm/primus`` and
``rocm/pytorch-training`` Docker images.
