...
.. note::
   ...
   training (legacy) </ai-training/primus/archive/megatron-lm>` workflow. To
   learn how to migrate workloads from Megatron-LM to Primus with Megatron, see
   :doc:`/ai-training/primus/archive/megatron-lm-primus-migration-guide`.
...
See :doc:`/ai-training/primus/archive/megatron-lm-history` to find
documentation for previous releases of the ``rocm/primus`` and
``rocm/megatron-lm`` Docker images.
