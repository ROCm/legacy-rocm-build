...
See `Hardware verification with ROCm <https://instinct.docs.amd.com/projects/system-acceptance/en/latest/gpus/mi300x.html#hardware-verification-with-rocm>`_ for more information.
