...
MPT-30B is a 30 billion parameter decoder-style transformer-based model
from the Mosaic Pretrained Transformer (MPT) family.
...
Using this image, you can build, run, and validate the training process
...
This training environment is defined in blah blah.
